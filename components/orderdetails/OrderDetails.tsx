...
const OrderDetails = ({payWay, address, prices}: propsType) => {
  ...
  return (
      ...
      <Flex fontFamily='IRANYekan' justifyContent="space-between" borderRadius="8px" bg={colorMode === 'light' ? "#E6E8EB" : '#151515'}  h="17.6vh" alignItems='center' m='auto' mt='50px' dir="rtl" p='32px'>
        <Box h='fit-content' w='13.021vw'>
          <Heading fontFamily='IRANYekan' color={colorMode === 'light' ? 'black' : "#FFFFFF"} as='h2' fontSize='24px' lineHeight='32px' fontWeight='500' display='block' mb='16px'>روش پرداخت</Heading>
        ...
        <Box h='fit-content' w='18.229vw'>
          <Heading fontFamily='IRANYekan' color={colorMode === 'light' ? 'black' : "#FFFFFF"} as='h2' fontSize='24px' lineHeight='32px' mb='16px' fontWeight='500' display='block'>روش پرداخت</Heading>
